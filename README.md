...
| [`docs/09-backtest.md`](docs/09-backtest.md) | **Kịch bản tự kiểm thử từ đầu**: 98 bước có ô tick, mốc dữ liệu chuẩn, chuỗi thông báo chính xác, 7 kịch bản theo vai trò, 12 kiểm tra âm, truy vấn DB đối chiếu, xử lý sự cố |
| [`docs/08-hieu-san-pham.md`](docs/08-hieu-san-pham.md) | **Đọc trước tiên nếu chưa rõ sản phẩm làm gì**: mục đích, 3 bề mặt, câu chuyện An Phát Land, ví dụ theo từng role, AI làm gì, từ điển thuật ngữ, kịch bản thử 10 phút |
